...
import 'package:realestate_ui/screens/detailPage.dart';
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          "3-4 Beds",
                          ">1500 sqft"
                        ].map((filter) => Choice(text: filter)).toList(),
                      ),
                    ),
                    Expanded(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (context) => DetailPage(itemData: item,)));
      },
      child: Container(
